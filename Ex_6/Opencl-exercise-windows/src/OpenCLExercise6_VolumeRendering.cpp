...
int main(int argc, char** argv) {
	...
	std::cout << std::hex << H5T_NATIVE_UINT16 << std::endl;
	std::cout << H5Tcopy(H5T_NATIVE_UINT16)<<std::endl;
	...
	boost::shared_ptr<Volume> volumeFile = HDF5::matlabDeserialize<Volume> ("C:/Users/ggcar/Documents/GPU-LAB-Supervision/GPU-LABWS2021/Ex1/Solution in Visual Studio/Opencl-Basics-Windows/Opencl-ex1/src/rpi-16.hdf5");
	...
	glutCreateWindow("OpenCL exercise 4: Volume rendering");
	...
	cl::Program program = OpenCL::loadProgramSource(context, "../../../src/OpenCLExercise6_VolumeRendering.cl");
	...
	d_invViewMatrix = cl::Buffer(context, CL_MEM_READ_WRITE, 16 * sizeof(float));
...
void render () {
	...
	if (runGpu) {
		...
		//TODO
		queue.enqueueWriteBuffer(d_invViewMatrix, true, 0, 16 * sizeof(float), invViewMatrix);
